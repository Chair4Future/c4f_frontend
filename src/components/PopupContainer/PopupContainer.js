    ...
    return (
      <div className="popup-container">
        <div
          ...
          className={
            open ? "popup-container-button active" : "popup-container-button"
          }
        >
...
const PopupContainerItem = props => {
  return (
    <div
      className="popup-container-item"
...
const PopupContainerDivider = props => {
  return (
    <div className="popup-container-divider">
      <div className={props.header ? "divider-name header" : "divider-name"}>
        {props.name}
      </div>
    </div>
  );
...
const PopupContainerUser = ({
  ...
  return (
    ...
    >
      <div
        className={
          isSelected ? "popup-container-user active" : "popup-container-user"
        }
        /*style={!isVisible? {display: "none"}:{}}*/ onClick={
          props.click && (() => props.click(id))
        }
      >
...
class PopupContent extends Component {
  render() {
    if (this.props.open)
      return (
        <div className="popup-container-content">{this.props.children}</div>
      );
    return null;
  }
}
